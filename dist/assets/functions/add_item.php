...
$con= mysqli_connect('localhost', 'root', '', 'nyikaclinic');
...
// define SQL query
$sql = "INSERT INTO drugs (upc, item_name, item_desc, category, quantity) VALUES ('$item_upc', '$item_name', '$item_desc', '$item_category', '$item_quantity')";
